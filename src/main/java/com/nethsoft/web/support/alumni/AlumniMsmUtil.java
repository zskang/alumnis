...
public class AlumniMsmUtil{


    //校友会帐号
    private static String account = "JSM4088904";
    //密码
    private static String password = "kisytel1";
    //校验码
    private static String veryCode = "rziwwb1pnusa";

    private static String validateCodeTempId="JSM40889-0006";//验证码的模板ID
...
//		params.append("&sendtime=").append("20151001113000"); //发送定时短信
     ...
     * @throws Exception
     */
    public static String sendCode(String mobile,String content) throws Exception{
        String address = HTTP_URL + "/service/httpService/httpInterface.do?method=sendMsg";
        ...
        params.append("&veryCode=").append(veryCode);
        params.append("&mobile=").append(mobile);
        params.append("&content=").append(String.format("@1@=%s", content));
        params.append("&msgtype=").append("2");
        params.append("&tempid=").append(validateCodeTempId);
        params.append("&code=").append("utf-8");
...
//        result.indexOf("</status>");
    ...
    public static void main(String[] args) throws Exception{
        String result = "";
        //发送普通短信
        //result = sendTextSms("15222918077", "您的验证码为：3123，请勿向任何人提供短信验证码");

        //发送模版短信
        result = sendTemplateSms("15222918077", "JSM40889-0004", "@1@=44444");
