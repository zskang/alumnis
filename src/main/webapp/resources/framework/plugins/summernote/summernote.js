...
(function (factory) {
  ...
  var EventHandler = function () {
    ...
    this.attachCustomEvent = function (layoutInfo, options) {
      ...
      // Textarea: auto filling the qrcode before form submit.
  ...
  $.fn.extend({
     ...
     * * get contents 
     * ```
     * var content = $("#summernote").qrcode();
     * ```
     * * set contents 
     *
     * ```
     * $("#summernote").qrcode(html);
     * ```
     *
     * @member $.fn 
