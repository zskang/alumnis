...
@Controller
@RequestMapping("/open/dev/table")
public class TableController {
	private final String TPL = "/open/dev/table/";
	...
	public String create(Model model){
		...
		model.addAttribute("columnTypes", ClassUtil.getFields(TypeMap.class));
		return TPL + "create";
	}
	...
	public JSONObject doCreate(Table table, String columns){
		try{
			...
			for(Object col : jColumns){
				...
				if(!StringUtil.isEmpty(jColumn.getString("size")))
