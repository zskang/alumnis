            ...
            onImageUpload: function(files) {
                ...
                void function (){
                    if(i < files.length){
                        ...
                        name = files[i].name;
                        $.ajax({
                            url : ns.getBasePath()+"/common/upload/summernote",
                            type : 'POST',
                            data : formData,
                            processData : false,
                            contentType : false,
                            ...
                            success : function(data) {
                                if(data.success){
                                    //插入图片到编辑框
                                    $("#summernote").summernote('insertImage',ns.getUploadPath()+data.path,name);
                                }else{
                                    ns.alert(data.error);
                                }
                            }
    ...
    var G = function (a) {
        ...
        var b = function (a, b) {
            ...
            image: function (a, b) {
                ...
                var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (i.isMac ? t(a, b) : u(t(a, b))) + '<pv class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.16</a> · <a href="//github.com/summernote/summernote" target="_blank">Project</a> · <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></pv>';
