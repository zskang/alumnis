 ...
 */
@Controller
@RequestMapping("/open/vc")
public class VerificationCodeController extends BaseController<Object> {
    ...
    public void crimg(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        session.setAttribute(ApplicationCommon.VERYFICATION_CODE, token);//存入Session中
    }
