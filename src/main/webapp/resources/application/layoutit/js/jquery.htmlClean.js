...
(function ($) {
    ...
    $.htmlClean.defaults = {
        ...
        // array of [attributeName], [optional array of allowed on elements] e.g. [["id"], ["style", ["pv", "dl"]]] // allow all elements to have id and allow style on 'pv' and 'dl'
        allowedAttributes: [],
        // array of attribute names to remove on all elements in addition to those not in tagAttributes e.g ["width", "height"]
        removeAttrs: [],
        // array of [className], [optional array of allowed on elements] e.g. [["aClass"], ["anotherClass", ["pv", "dl"]]]
        allowedClasses: [],
        // format the result
        format: false,
