  ...
  */
  ...
  ParsleyUI.prototype = {
    ...
    addError: function (fieldInstance, name, message, assert, doNotUpdateClass) {
    	...
    	element.tooltip({title:(message || this._getErrorMessage(fieldInstance, assert)), placement:"right"});
    ...
    updateError: function (fieldInstance, name, message, assert, doNotUpdateClass) {
	    ...
	    if(element.parent().find(".chosen-container").length > 0){
     	...
     	element.tooltip({title:(message || this._getErrorMessage(fieldInstance, assert)), placement:"top"});
 	    element.tooltip("show");
    	/*fieldInstance._ui.$errorsWrapper
        .addClass('filled')
        .find('.parsley-' + name)
